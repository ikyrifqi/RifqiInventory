...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 05 Apr 2020 pada 17.34
...
(3, 'Vokasi', '2020-04-05 08:25:21', '2020-04-05 08:25:21');
...
(1, 1, 'Mesin', '2020-04-05 08:08:20', '2020-04-05 08:08:20'),
(2, 3, 'TIK', '2020-04-05 08:25:41', '2020-04-05 08:25:41');
...
(3, '2020_04_05_115314_create_fakultas', 1),
(4, '2020_04_05_115437_create_jurusan', 1);
...
ALTER TABLE `jurusan`
  ADD PRIMARY KEY (`id`),
  ADD KEY `jurusan_fakultas_id_index` (`fakultas_id`);
